...
{{--            <div class="ticketstatus-container justify-center flex flex-col">--}}
...
@extends('layouts.layout')
@section('content')
    <div class="flex flex-col mt-20 mx-auto w-full max-w-lg">
        <div class=" pt-10 flex flex-wrap -mx-8 mb-6">
            <div class=" md:w-1/2 px-3 mb-6 md:mb-0">
                <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                    ...
                    <div class="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <div class="block w-full lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" style="background-image: url('https://source.unsplash.com/MP0IUfwrn0A')"></div>
