...
@section('content')
    <form method="post" action="{{ route('home.index') }}" class="mt-20 mx-auto w-full max-w-lg">
        @csrf
        ...
        <div class=" pt-10 flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                    ...
                    value="{{ old('firstname') }}" id="firstname" type="text" placeholder="Jane">
            ...
            <div class="w-full md:w-1/2 px-3">
                ...
                <input
                    ...
                    value="{{ old('lastname') }}" id="lastname" type="text" placeholder="Doe">
            </div>
            <div class="w-full md:w-1/2 px-3">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">
                    email
                ...
                <input
                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    value="{{ old('email') }}" id="email" type="text" placeholder="Doe">
                @error('email')
            ...
            <div class="studentnumber">
                ...
                <input
                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    value="{{ old('student_number') }}" id="studentnumber" type="text" placeholder="102">
                ...
                <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
                    <div class="container mx-auto px-4 py-2 md:py-10">
                        <div class="mb-5 w-64">
                            ...
                            <label for="datepicker" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Date of birth</label>
                            <div class="relative">
        ...
        <div class="col-md-6">
            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="password-confirm" type="password" class="form-control" name="password_confirmation" required
