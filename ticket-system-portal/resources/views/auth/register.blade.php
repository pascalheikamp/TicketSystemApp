...
@section('content')
    <form class=" border-2 mx-auto w-full max-w-lg">
        ...
        <button class="justify-center flex flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded" type="button">
            Sign Up
        </button>
    </form>
@endsection
