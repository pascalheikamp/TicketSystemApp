   ...
   <section class=" fixed top-20  bg-cover bg-center py-32" style=background-color:#f8f8ff>
       <div class="bottom-20 mb-10 card">
           <div
               ...
               <div
                   ...
                   <div class="flex h-full items-center justify-center">
                       <div class="px-6 text-center text-white md:px-12">
                           ...
                           <h3 class="mb-8 text-2xl font-bold"> Dashboard</h3>
                       </div>
                   </div>
               </div>
           </div>
    <div class="container text-center text-black">
        <img height="500px" width="auto" src="{{Vite::asset('resources/images/student-header.jpg')}}"/>
    </div>
   </section>
